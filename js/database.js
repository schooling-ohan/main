...
function friendsload(){
    ...
    siteListref.on('value', function(snapshot) {
        ...
        if (friendskeyArray.length % 2 == 0) {
            ...
            constantine.push('<div class="onlyconstantine"><hr class="friendLong"><div class="thing"><div class="line1"><label class="nickname">' + reversevalue[last][0] + '</label><hr class="nick_report"><label class="report" onclick="report(this.id);" style="cursor: pointer;" id="' + reversevalue[last][0] + '_r">신고</label></div><div class="line2"><div class="smallHeartCover" onclick="smallHeart(this.id);" style="cursor: pointer;" id="_s' + reversevalue[last][0] + '"><div class="smallHeart"></div></div><label class="text" id="text">' + reversevalue[last][1] + '</label><div class="bigHeartCover" onclick="bigHeart(this.id);" style="cursor: pointer;" id="_b' + reversevalue[last][0] + '"><div class="bigHeartText">0</div><div class="bigHeart"></div></div></div></div></div>');
        }
